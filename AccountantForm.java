...
public class AccountantForm extends JFrame {
	...
	public AccountantForm() {
		...
		lblAddAccountant.setForeground(Color.BLUE);
		lblAddAccountant.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			int i=AccountantDao.save(name, password, email, address, city, contact);
			if(i>0){
			...
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
						...
						.addComponent(lblEmail, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.DEFAULT_SIZE)
