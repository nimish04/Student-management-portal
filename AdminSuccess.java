...
public class AdminSuccess extends JFrame {
	...
	public AdminSuccess() {
		...
		btnViewAccountant.setFont(new Font("Tahoma", Font.PLAIN, 15));
		
		JButton btnDeleteAccountant = new JButton("Remove Accountant");
		btnDeleteAccountant.setBackground(Color.BLUE);
		...
		btnDeleteAccountant.setFont(new Font("Tahoma", Font.PLAIN, 15));
			...
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(btnDeleteAccountant, GroupLayout.PREFERRED_SIZE, 181, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnViewAccountant, GroupLayout.PREFERRED_SIZE, 181, GroupLayout.PREFERRED_SIZE)
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(18)
					.addComponent(btnViewAccountant, GroupLayout.PREFERRED_SIZE, 49, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
					.addComponent(btnDeleteAccountant, GroupLayout.PREFERRED_SIZE, 49, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
